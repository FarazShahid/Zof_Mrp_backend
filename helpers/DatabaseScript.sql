...
ADD COLUMN `TopRight` DECIMAL(5,2) NULL,
ADD COLUMN `TopLeft` DECIMAL(5,2) NULL,
ADD COLUMN `BottomRight` DECIMAL(5,2) NULL,
ADD COLUMN `BottomLeft` DECIMAL(5,2) NULL,
ADD COLUMN `Back` DECIMAL(5,2) NULL;
