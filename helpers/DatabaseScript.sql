...
ALTER TABLE `orders`
MODIFY COLUMN `OrderEventId` INT(11) NULL DEFAULT NULL;


ALTER TABLE `orderitemdetails`
MODIFY COLUMN `ColorOptionId` INT(11) NULL DEFAULT NULL;


-- 19/07/2025

ALTER TABLE `sizemeasurements`
ADD COLUMN Neckwidth DECIMAL(5,2) NULL,
ADD COLUMN CollarOpening DECIMAL(5,2) NULL,
ADD COLUMN ArmHoleStraight DECIMAL(5,2) NULL,
ADD COLUMN BottomRib DECIMAL(5,2) NULL,
ADD COLUMN WasitStretch DECIMAL(5,2) NULL,
ADD COLUMN WasitRelax DECIMAL(5,2) NULL,
ADD COLUMN Thigh DECIMAL(5,2) NULL,
ADD COLUMN BackRise DECIMAL(5,2) NULL,
ADD COLUMN TotalLength DECIMAL(5,2) NULL,
ADD COLUMN WBHeight DECIMAL(5,2) NULL,
ADD COLUMN bBottomWidth DECIMAL(5,2) NULL,
ADD COLUMN BottomOriginal DECIMAL(5,2) NULL,
ADD COLUMN BottomElastic DECIMAL(5,2) NULL,
ADD COLUMN BottomCuffZipped DECIMAL(5,2) NULL,
